...
namespace SMSManager
{
    class GSMsms
    {
        ...
        public void Send(string toAdress, string message)
        {
            ...
            //gsmPort.Write("AT+CMGF=1\r"); // Set mode to Text(1) or PDU(0)
            //Thread.Sleep(1000);
            //gsmPort.Write("AT+CSCA=servicecenter\r\n");
            //Thread.Sleep(1000);
            //gsmPort.Write($"AT+CMGS=\"{toAdress}\"");
            //Thread.Sleep(1000);
            //gsmPort.Write(message + char.ConvertFromUtf32(26));
            //Thread.Sleep(5000);
            ...
            Thread.Sleep(100);
            gsmPort.WriteLine("AT+CSCS=\"GSM\"" + Environment.NewLine);
            Thread.Sleep(100);
            gsmPort.WriteLine("AT+CMGS=\"" + toAdress + "\"" + Environment.NewLine);
            Thread.Sleep(100);
            gsmPort.WriteLine(message + Environment.NewLine);
            Thread.Sleep(100);
